...
exec spInsertarEmpleado 'Kimberly', 'Cuadros', 'Av Pershing', 1, '2003-01-09', 4

select*from Marca
exec spInsertarMarca 3
...
update Marca set tipo = 'EI' where MarcaID = 6
update Marca set tipo = 'SI' where MarcaID = 7 
update Marca set tipo = 'EF' where MarcaID = 8 
update Marca set tipo = 'SF' where MarcaID = 9 